...
\n/oynat - Mp3 Formatına uygun dosyaları çalıştırmak için
/bul - istediğiniz şarkıları hızlı bir şekilde indirin
/ytplay - Youtube'dan istediğiniz müziği çalar
/id - Sohbet id ve Kullanıcının id'si halkında bilgi verir
...
/ayril - Yönetici listesini yenile
